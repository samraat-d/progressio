...
import 'passwordconfirm_model.dart';
export 'passwordconfirm_model.dart';

class PasswordconfirmWidget extends StatefulWidget {
  const PasswordconfirmWidget({
    super.key,
    String? passconfirmtext,
  }) : passconfirmtext = passconfirmtext ?? 'Error! Password Invalid';

  final String passconfirmtext;
...
class _PasswordconfirmWidgetState extends State<PasswordconfirmWidget> {
  late PasswordconfirmModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PasswordconfirmModel());
  }
