...
DocumentReference? get currentUserReference =>
    loggedIn ? AccountsRecord.collection.doc(currentUser!.uid) : null;

AccountsRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : AccountsRecord.getDocument(AccountsRecord.collection.doc(uid))
              .handleError((_) {}),
    )
    .map((user) {
