...
import '/components/new_password/new_password_widget.dart';
...
class _ProfileWidgetState extends State<ProfileWidget>
  ...
  void initState() {
    ...
    _model.linksFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<AccountsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<AccountsRecord> profileAccountsRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final profileAccountsRecord = profileAccountsRecordList.isNotEmpty
            ? profileAccountsRecordList.first
            : null;
                ...
                children: [
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller: _model.fullnameTextController ??=
                                    ...
                                    text: profileAccountsRecord?.displayName,
                                  ),
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller: _model.contactTextController ??=
                                      TextEditingController(
                                    text: profileAccountsRecord?.phoneNumber,
                                  ),
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.professionTextController ??=
                                          TextEditingController(
                                    text: profileAccountsRecord?.profession,
                                  ),
                            ...
                            Expanded(
                              child: Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 0.0, 30.0, 0.0),
                                child: TextFormField(
                                  controller: _model.linksTextController ??=
                                      TextEditingController(
                                    text: profileAccountsRecord?.links,
                                  ),
                                  focusNode: _model.linksFocusNode,
                                  autofocus: true,
                                  obscureText: false,
                                  decoration: InputDecoration(
                                    labelText: 'Github/LinkedIn',
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                          fontFamily: 'Readex Pro',
                                  ...
                                  validator: _model.linksTextControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await profileAccountsRecord!.reference
                            ...
                            links: _model.linksTextController.text,
                          ));
